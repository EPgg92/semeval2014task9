...
def main():
	file=input("Nom du fichier à traiter : ") # On récupére le nom du fichier à traité
	nomfichier=input("Nommer votre fichier de sortie : ")+".txt" # on nomme le fichier que l'on va créer à partir 
