...
if len(sys.argv)==4:
    ...
    print("Usage:")
    print("To run scorer: python3 "+sys.argv[0]+" a|b <predictions> <gold_standard>")
    print("To verify format: python3 "+sys.argv[0]+" a|b <predictions> ")
    exit(-1)
...
def fscore(conftable):
    if conftable[0]==0 or conftable[1]==0 or conftable[2]==0:
        return [0.0,0.0,0.0]
    precision = conftable[0]/conftable[2]
    recall = conftable[0]/conftable[1]
