...
###################################################################################################
#
# Essayer de résoudre le problème d'invercement de vercors et de weight dans le neuronne !
#
###################################################################################################
...
def main():
	...
	for i in range(0,lim):
		...
		nomfichier= "test3.9."+str(i)+".txt" #input("Nommer votre fichier de sortie : ")+".txt" # on nomme le fichier que l'on va créer à partir
...
def weightsValue(vectors):# weightsValue calcule les différents vecteurs de poids avec une tolérance d'erreur
	...
	wNeutral=neurone(vectors,allWeight, "neutral", 0.009)
	print("Calcul des poids pour les positifs:")
	wPositive=neurone(vectors,allWeight, "positive", 0.009)
	print("Calcul des poids pour les negatifs:") # best 0.024
	wNegative=neurone(vectors,allWeight, "negative", 0.009)
